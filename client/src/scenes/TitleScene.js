...
export default class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.button1 = new Button(this, 50, 300, 'Start Game', function() {
            clickSound.play()
        ...
        this.button2 = new Button(this, 50, 400, 'How To Play', function() {
            clickSound.play()
            self.cameras.main.fadeOut(FADE_DURATION)
            invisiblePixel.setInteractive()
            self.cameras.main.once('camerafadeoutcomplete', function (camera) {
        ...
        this.button3 = new Button(this, 50, 500, 'Credits', function() {
            clickSound.play()
            self.cameras.main.fadeOut(FADE_DURATION)
            invisiblePixel.setInteractive()
            self.cameras.main.once('camerafadeoutcomplete', function (camera) {
